...
public class ActiveController {
    ...
    * */
    ...
    public List<HashMap<String, String>> getList(String tag) {
        ...
        convert1.put("value",String.valueOf(convertData.getVisitor2order_convert_ratio()));

        HashMap<String, String> convert2 = new HashMap<>();
        convert2.put("name","支付");
        convert2.put("value",String.valueOf(convertData.getOrder2payment_convert_ratio()));
